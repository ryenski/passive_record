...
Download PassiveRecord from Github: http://github.com/artofmission/passiverecord

=== Install using Git Submodules: 

  git submodule add http://github.com/artofmission/passiverecord vendor/plugins/passiverecord
  git submodule init
  git submodule update

=== Install with Rails' plugin installer

  ./script/plugin install git://github.com/artofmission/passiverecord.git
